                        ...
                        <article className="bg-white rounded-2xl p-6 md:p-10 shadow-sm border border-slate-100">
                            ...
                            <div className="flex items-center gap-3 my-6">
                                <a
                                    ...
                                    className="w-10 h-10 bg-[#1877F2] text-white rounded-lg flex items-center justify-center hover:opacity-90 transition shadow-sm"
                                ...
                                <a
                                    href={`https://t.me/share/url?url=${typeof window !== 'undefined' ? window.location.href : ''}&text=${encodeURIComponent(article.title)}`}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-10 h-10 bg-[#24A1DE] text-white rounded-lg flex items-center justify-center hover:opacity-90 transition shadow-sm"
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-10 h-10 bg-[#25D366] text-white rounded-lg flex items-center justify-center hover:opacity-90 transition shadow-sm"
                                ...
                                <a
                                    href={`fb-messenger://share/?link=${typeof window !== 'undefined' ? window.location.href : ''}`}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-10 h-10 bg-gradient-to-r from-[#00B2FF] to-[#006AFF] text-white rounded-lg flex items-center justify-center hover:opacity-90 transition shadow-sm hidden md:flex"
                                ...
                                >
                                    {/* Messenger Logo */}
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.373 0 0 4.974 0 11.111c0 3.498 1.744 6.614 4.469 8.654V24l4.088-2.242c1.092.3 2.246.464 3.443.464 6.627 0 12-4.975 12-11.111C24 4.974 18.627 0 12 0zm1.191 14.963l-3.056-3.256-5.963 3.256 6.559-6.963 3.13 3.256 5.914-3.256-6.584 6.963z" /></svg>
                                </a>
                            </div>
