...
export default function NewsSlider({ images, title }) {
  ...
  if (images.length === 1) {
    return (
      <div className="relative w-full aspect-video rounded-xl overflow-hidden shadow-lg border border-slate-100">
        <Image
          src={images[0]}
          alt={title}
          fill
  ...
  return (
    <div className="relative w-full aspect-video bg-slate-100 rounded-xl overflow-hidden shadow-lg border border-slate-100 group">
      {/* ছবি */}
